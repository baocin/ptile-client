...
| address | `PTILESD\x00` | 1, 2 | {STATE}.address_v2.ptiles as published since the builder stopped truncating PTILESA2 to the admin magic. v2 records carry i16 cell-relative coordinates; v1 has none. Older published address files still say PTILESA and are accepted under that entry |
